...
######################################################################################################################
#outliers_method
# The method used for outlier testing IS null as you already removed outliers in the additional occurrences script
# Leaving thinning for ENMTML (RES)
#outliers_mtp
...
#################ATTENTION####################################################################################
#
# Since the st_crop was not working AND the rnaturalearth shapefile is not accurate for 
