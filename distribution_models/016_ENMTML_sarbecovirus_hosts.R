...
#Time difference of 3.632294 hours
...
f_occ <- "D:/OneDrive - Massey University/_env/sdm_inputs/CC_master_bat_data_2021_09_D16.txt"
...
ENMTML( pred_dir = d_climate,
        ...
        colin_var= NULL, 
        imp_var = TRUE,
        sp_accessible_area=c(method='MASK', filepath='D://OneDrive - Massey University//_env//olson/wwf_terr_ecos.shp'), #c(method='BUFFER', type='2', width='320'),
